...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-lg grid-cols-5 overflow-hidden rounded-[1.2rem] border border-white/[0.1] bg-[#07101e]/94 p-1.5 shadow-[0_18px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl">
        {mobileNavItems.map((item) => {
          ...
          return (
            ...
            >
              {active ? <span className="absolute inset-x-5 top-0 h-px bg-[linear-gradient(90deg,var(--accent),var(--agoge-red))] shadow-[0_0_10px_rgba(79,140,255,0.55)]" /> : null}
